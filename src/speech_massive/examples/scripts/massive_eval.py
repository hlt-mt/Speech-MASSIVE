...
class MassiveEval:
    ...
    def __init__(self):
        self.t2t_args = {'input_prompt' : "Annotate: ", 'use_output_descrip' : False, 'intent_first' : False,
    ...
    def eval_preds(self, pred_intents=None, lab_intents=None, pred_slots=None, lab_slots=None,
    ...
    def convert_t2t_batch_to_intents_slots(self, mod_out, use_output_descrip=False, intent_first=False,
                                        slots_mixed=False, toks_in_output=False, sentinels=False,
